...
export default function Navbar() {
  ...
  const navBtn =
    "cta-anim inline-flex items-center justify-center rounded-full bg-cta text-white font-semibold text-[.92rem] px-5 py-2.5 transition-all duration-200 hover:bg-cta-d hover:-translate-y-0.5 hover:scale-[1.04]";
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-7">
          ...
          <Link
            href="/commander"
            onClick={() => setOpen(false)}
            className="cta-anim mt-8 flex items-center justify-center gap-2 w-full rounded-full bg-cta text-white font-semibold text-[1rem] py-3.5 shadow-[0_10px_24px_-8px_rgba(199,91,51,.6)] transition-all duration-200 hover:bg-cta-d hover:scale-[1.02]"
          >
