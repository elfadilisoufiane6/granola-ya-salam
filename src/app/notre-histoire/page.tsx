...
export const metadata: Metadata = {
  ...
  description:
    "L'histoire de Granola Ya Salame — fondée par Khadija dans sa cuisine à Casablanca. Un granola fait main, sans conservateurs ni sucre raffiné, préparé comme pour sa propre famille.",
};
