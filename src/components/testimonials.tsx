...
const reviews = [
  ...
  { q: "Khedma nqiya w propre. La commande wseltni f youmayn l Rabat, emballage soigné. Ana wlit cliente fidèle, nechri kol chher.", n: "Ayat B.", city: "Rabat", i: "AB", c: "bg-[#C75B33]" },
